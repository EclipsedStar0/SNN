        ...
        for epoch in range(epochs):
            ...
            for x, y, mask in pbar:
                ...
                if global_step % save_interval == 0:
                    self.model.save_checkpoint(f'models/text_completion_20_C_checkpoint_step_{global_step}.pth')
...
if __name__ == "__main__":
    ...
    tokenizer = SimpleBPETokenizer()
    tokenizer.train(training_data, vocab_size=1000)
    ...
    losses = trainer.train(training_data, epochs=100, batch_size=256)
    
    # Save final model
    model.save_checkpoint('models/text_completion_20_C_Final.pth')